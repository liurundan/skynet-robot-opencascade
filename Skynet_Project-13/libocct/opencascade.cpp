...
void Opencascade::setup_tcp_origin(){
    ...
    m_context->SetColor(aisBody_tcp_zaxis,Quantity_NOC_BLUE1,Standard_False);
...
void Opencascade::draw_preview_cone(std::string type, gp_Trsf trsf){
    ...
    if(type=="waypoint"){
        m_context->SetColor(previewbucketvec.back(),Quantity_NOC_BLUE1,Standard_False);
    }
    if(type=="endpoint"){
...
void Opencascade::m_initialize_context()
{
    if (m_context.IsNull())
    {
        ...
        //datumAspect->ShadingAspect(Prs3d_DP_ZAxis)->SetColor(Quantity_NOC_BLUE12);
        ...
        aisTrihedron->SetDatumPartColor(Prs3d_DP_ZAxis, Quantity_NOC_BLUE12);
...
//    m_context->SetColor(aisBody_euler_begin_z_axis,Quantity_NOC_BLUE1,Standard_False);
...
//    m_context->SetColor(aisBody_euler_end_z_axis,Quantity_NOC_BLUE1,Standard_False);
